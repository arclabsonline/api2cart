...
module SwaggerClient
  class ProductApi
    ...
    def product_image_add(product_id, image_name, type, url, opts = {})
      data, _status_code, _headers = product_image_add_with_http_info(product_id, image_name, type, url, opts)
      return data
    end
    ...
    def product_image_add_with_http_info(product_id, image_name, type, url, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && url.nil?
        fail ArgumentError, "Missing the required parameter 'url' when calling ProductApi.product_image_add"
      end
      # resource path
    ...
    # @option opts [String] :product_variant_params Set this parameter in order to choose which product variants fields you want to retrieve (default to force_all)
    # @option opts [Integer] :since_id Retrieve products starting from the specified product id
    # @option opts [String] :report_request_id Report request id
    # @option opts [BOOLEAN] :disable_report_cache Disable report cache for current request (default to false)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :name Defines variant&#39;s name that has to be added
    # @option opts [Float] :price Defines new product&#39;s variant price
    # @option opts [Array<String>] :attributes Defines variant&#39;s attributes list
    # @option opts [String] :description Specifies variant&#39;s description
    # @option opts [Float] :special_price Specifies variant&#39;s model that has to be added
    # @option opts [String] :sprice_create Defines the date of special price creation
    # @option opts [String] :sprice_modified Defines the date of special price modification
    # @option opts [String] :sprice_expire Defines the term of special price offer duration
    # @option opts [BOOLEAN] :available_for_view Specifies the set of visible/invisible product&#39;s variants for users (default to true)
    # @option opts [BOOLEAN] :available_for_sale Specifies the set of visible/invisible product&#39;s variants for sale (default to true)
    # @option opts [Float] :weight Weight (default to 0)
    # @option opts [String] :short_description Defines short description
    # @option opts [String] :warehouse_id This parameter is used for selecting a warehouse where you need to set/modify a product quantity.
    # @option opts [Float] :quantity Defines product variant&#39;s quantity that has to be added (default to 0)
    # @option opts [String] :created_at Defines the date of entity creation
    # @option opts [String] :manufacturer Specifies the product variant&#39;s manufacturer
    # @option opts [Integer] :tax_class_id Defines tax classes where entity has to be added
    # @option opts [String] :meta_title Defines unique meta title for each entity
    # @option opts [String] :meta_keywords Defines unique meta keywords for each entity
    # @option opts [String] :meta_description Defines unique meta description of a entity
    # @option opts [String] :url Defines unique product variant&#39;s URL
    # @option opts [String] :store_id Add variants specified by store id
    # @return [InlineResponse20073]
    def product_variant_add(product_id, model, opts = {})
      data, _status_code, _headers = product_variant_add_with_http_info(product_id, model, opts)
      return data
    end
    ...
    # @option opts [String] :sprice_modified Defines the date of special price modification
    # @option opts [String] :sprice_expire Defines the term of special price offer duration
    # @option opts [BOOLEAN] :available_for_view Specifies the set of visible/invisible product&#39;s variants for users
    # @option opts [BOOLEAN] :available_for_sale Specifies the set of visible/invisible product&#39;s variants for sale
    # @option opts [Float] :weight Weight
    # @option opts [String] :short_description Defines short description
    # @option opts [String] :warehouse_id This parameter is used for selecting a warehouse where you need to set/modify a product quantity.
    # @option opts [Float] :quantity Defines product variant&#39;s quantity that has to be added
    # @option opts [String] :created_at Defines the date of entity creation
    # @option opts [String] :manufacturer Specifies the product variant&#39;s manufacturer
    # @option opts [Integer] :tax_class_id Defines tax classes where entity has to be added
    # @option opts [String] :meta_title Defines unique meta title for each entity
    ...
    def product_variant_add_with_http_info(product_id, model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProductApi.product_variant_add ..."
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling ProductApi.product_variant_add"
      end
      # verify the required parameter 'model' is set
      if @api_client.config.client_side_validation && model.nil?
        fail ArgumentError, "Missing the required parameter 'model' when calling ProductApi.product_variant_add"
      end
      # resource path
      ...
      query_params[:'special_price'] = opts[:'special_price'] if !opts[:'special_price'].nil?
      query_params[:'sprice_create'] = opts[:'sprice_create'] if !opts[:'sprice_create'].nil?
      query_params[:'sprice_modified'] = opts[:'sprice_modified'] if !opts[:'sprice_modified'].nil?
      query_params[:'sprice_expire'] = opts[:'sprice_expire'] if !opts[:'sprice_expire'].nil?
      query_params[:'available_for_view'] = opts[:'available_for_view'] if !opts[:'available_for_view'].nil?
      query_params[:'available_for_sale'] = opts[:'available_for_sale'] if !opts[:'available_for_sale'].nil?
      query_params[:'weight'] = opts[:'weight'] if !opts[:'weight'].nil?
      query_params[:'short_description'] = opts[:'short_description'] if !opts[:'short_description'].nil?
      query_params[:'warehouse_id'] = opts[:'warehouse_id'] if !opts[:'warehouse_id'].nil?
      query_params[:'quantity'] = opts[:'quantity'] if !opts[:'quantity'].nil?
      ...
      query_params[:'manufacturer'] = opts[:'manufacturer'] if !opts[:'manufacturer'].nil?
      query_params[:'tax_class_id'] = opts[:'tax_class_id'] if !opts[:'tax_class_id'].nil?
      query_params[:'meta_title'] = opts[:'meta_title'] if !opts[:'meta_title'].nil?
      query_params[:'meta_keywords'] = opts[:'meta_keywords'] if !opts[:'meta_keywords'].nil?
      query_params[:'meta_description'] = opts[:'meta_description'] if !opts[:'meta_description'].nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [InlineResponse2004]
    def product_variant_delete(id, opts = {})
      data, _status_code, _headers = product_variant_delete_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InlineResponse2004, Fixnum, Hash)>] InlineResponse2004 data, response status code and response headers
    def product_variant_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :meta_description Defines unique meta description of a entity
    # @option opts [String] :meta_keywords Defines unique meta keywords for each entity
    # @option opts [String] :description2 Specifies variant&#39;s description
    # @option opts [String] :short_description Defines short description
    # @option opts [String] :visible Set visibility status
    ...
    def product_variant_update_with_http_info(id, product_id, opts = {})
      ...
      query_params[:'meta_description'] = opts[:'meta_description'] if !opts[:'meta_description'].nil?
      query_params[:'meta_keywords'] = opts[:'meta_keywords'] if !opts[:'meta_keywords'].nil?
      query_params[:'description'] = opts[:'description2'] if !opts[:'description2'].nil?
      query_params[:'short_description'] = opts[:'short_description'] if !opts[:'short_description'].nil?
      query_params[:'visible'] = opts[:'visible'] if !opts[:'visible'].nil?
      query_params[:'status'] = opts[:'status'] if !opts[:'status'].nil?
      query_params[:'weight'] = opts[:'weight'] if !opts[:'weight'].nil?
