...
module SwaggerClient
  ...
  class Coupon
    ...
    def hash
      [id, code, name, description, actions, date_start, date_end, avail, priority, used_times, usage_limit, usage_limit_per_customer, logic_operator, conditions, usage_history, additional_fields, custom_fields].hash
    end
