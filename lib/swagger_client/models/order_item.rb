...
module SwaggerClient
  ...
  class OrderItem
    ...
    def hash
      [product_id, order_product_id, model, name, price, quantity, total_price, tax_percent, tax_value, options, variant_id, weight_unit, weight, additional_fields, custom_fields].hash
    end
