...
module SwaggerClient
  ...
  class Order
    ...
    def self.swagger_types
      {
        :'id' => :'String',
        :'order_id' => :'String',
        :'customer' => :'InlineResponse20056Result',
        :'create_at' => :'DateTime',
        :'currency' => :'Currency',
    ...
    def hash
      [id, order_id, customer, create_at, currency, shipping_address, billing_address, payment_method, shipping_method, shipping_methods, status, totals, total, discounts, order_products, modified_at, finished_time, comment, store_id, additional_fields, custom_fields].hash
    end
